...
export const ACTION_LABELS: Record<string, string> = {
  ...
  'sermon.create': 'Added teaching message',
  'sermon.update': 'Edited teaching message',
  'sermon.publish': 'Published teaching message',
  'sermon.unpublish': 'Unpublished teaching message',
  'sermon.delete': 'Removed teaching message',
  'series.create': 'Added series',
  'series.update': 'Edited series',
  'series.delete': 'Removed series',
  'liveMeeting.create': 'Scheduled live meeting',
  'liveMeeting.update': 'Edited live meeting',
  'liveMeeting.delete': 'Removed live meeting',
...
export const ENTITY_TYPE_LABELS: Record<string, string> = {
  ...
  ministry: 'Ministries',
  sermon: 'Teaching',
  sermonSeries: 'Teaching series',
  liveMeeting: 'Live meetings',
